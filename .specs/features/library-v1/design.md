...
Pacotes: `catalog` (busca e RAWG) e `tracking` (jogos acompanhados e sessões). Dentro de cada um: `domain`, `application`, `adapter`.
...
- **Location**: `src/main/java/com/brunoandreotti/game_tracker/catalog/application/GameCatalog.java`
- **Interfaces**:
...
- **Location**: `src/main/java/com/brunoandreotti/game_tracker/catalog/adapter/http/RawgGameCatalog.java`
...
- **Location**: `src/main/java/com/brunoandreotti/game_tracker/catalog/application/GameSearchService.java`
...
- **Location**: `src/main/java/com/brunoandreotti/game_tracker/catalog/adapter/web/GameSearchController.java`
...
- **Location**: `src/main/java/com/brunoandreotti/game_tracker/tracking/domain/TrackedGame.java`
...
- **Location**: `src/main/java/com/brunoandreotti/game_tracker/tracking/domain/PlaySession.java`
...
- **Location**: `src/main/java/com/brunoandreotti/game_tracker/tracking/application/TrackedGameRepository.java`
...
- **Location**: `src/main/java/com/brunoandreotti/game_tracker/tracking/application/PlaySessionRepository.java`
...
- **Location**: `src/main/java/com/brunoandreotti/game_tracker/tracking/adapter/persistence/`
...
- **Location**: `src/main/java/com/brunoandreotti/game_tracker/tracking/application/TrackedGameService.java`
- **Interfaces**:
...
- **Location**: `src/main/java/com/brunoandreotti/game_tracker/tracking/adapter/web/TrackedGameController.java`
...
- **Location**: `src/main/java/com/brunoandreotti/game_tracker/tracking/application/SessionService.java`
- **Interfaces**:
...
- **Location**: `src/main/java/com/brunoandreotti/game_tracker/tracking/adapter/web/SessionController.java`
...
- **Dependencies**: exceções de `catalog` e `tracking`
- **Reuses**: Spring MVC
