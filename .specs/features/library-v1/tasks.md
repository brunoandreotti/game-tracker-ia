...
**Where**: `src/main/java/com/brunoandreotti/game_tracker/core/port/out/GameCatalogPort.java`
**Depends on**: T1
...
**Where**: `src/main/java/com/brunoandreotti/game_tracker/adapter/out/rawg/RawgGameCatalogAdapter.java`
**Depends on**: T6
...
**Where**: `src/main/java/com/brunoandreotti/game_tracker/core/port/in/GameSearchService.java`
**Depends on**: T6
...
**Where**: `src/main/java/com/brunoandreotti/game_tracker/adapter/in/web/GameSearchController.java`
**Depends on**: T5, T7, T8
...
- [x] No Spring or JPA imports in `core/model`
- [x] Gate check passes: `mvn -q package`
...
**Where**: `src/main/java/com/brunoandreotti/game_tracker/core/model/PlaySession.java`
**Depends on**: T10
**Reuses**: T10 package `core/model`
**Requirement**: LIB-27
...
**Where**: `src/main/java/com/brunoandreotti/game_tracker/core/port/out/PlaySessionRepository.java`
**Depends on**: T12
...
- [x] Entity lives only in `adapter/out/persistence`
- [x] Gate check passes: `mvn -q package`
...
**Where**: `src/main/java/com/brunoandreotti/game_tracker/adapter/out/persistence/PlaySessionEntity.java`
**Depends on**: T14
...
**What**: `JpaTrackedGameRepository` implements `TrackedGameRepository`. Maps entity ↔ domain. Spring Data stays inside `adapter/out/persistence`.
...
**Where**: `src/main/java/com/brunoandreotti/game_tracker/adapter/out/persistence/JpaPlaySessionRepository.java`
**Depends on**: T16
...
**Where**: `src/main/java/com/brunoandreotti/game_tracker/core/port/in/TrackedGameService.java`
**Depends on**: T6, T17
...
**Where**: `src/main/java/com/brunoandreotti/game_tracker/core/port/in/SessionService.java`
**Depends on**: T17
